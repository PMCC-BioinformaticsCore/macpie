...
mac_dmso@assays$RNA$counts.PMMSq033 <- NULL
mac_dmso@assays$RNA$counts.PMMSq034 <- NULL
mac_dmso@assays$RNA$counts <- mac_dmso_counts
mac_dmso$combined_raw <- paste0(mac_dmso$orig.ident,"_", mac_dmso$Row)

plot_mds(combined, group_by = "Sample_type", label = "orig.ident", n_labels = 30)
plot_mds(mac_dmso, group_by = "Sample_type", label = "orig.ident", n_labels = 30)
plot_rle(mac_dmso, label_column = "orig.ident")
