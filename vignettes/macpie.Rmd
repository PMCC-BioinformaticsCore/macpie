...
- [Assessing sparsity](assessing_zero_inflation.html)
- [Working with Bioconductor classes](macpie_bioc.html)
...
# Train random forest
rf_model <- randomForest(Combined.Score ~ ., data = model_df, importance = TRUE, na.action = na.omit, ntrees = 500)
...
varImpPlot(rf_model, n.var = 20, main = "Top 20 Random Forest Features", type = 2)
```
