...
Plate layout for PMMSq033:

```{r two_plates_plate_layout_plate1, fig.width = 8, fig.height = 6}
...
Plate layout for PMMSq034:

```{r two_plates_plate_layout_plate2, fig.width = 8, fig.height = 6}
...
combined_edgeR <- compute_single_de(combined, treatment_samples, control_samples, method = "edgeR")
