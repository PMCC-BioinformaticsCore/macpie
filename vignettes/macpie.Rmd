...
```{r violin_plot, fig.width = 8, fig.height = 6}
...
```{r subset_seurat, fig.width = 10, fig.height = 6}
...
```{r mds_plot, fig.width = 8, fig.height = 8}
...
```{r plot_rle, fig.width = 8, fig.height = 7}
...
```{r compute_multi_screen_profile, fig.width = 15, fig.height = 5}
