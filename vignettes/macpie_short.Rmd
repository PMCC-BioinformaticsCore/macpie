...
**Data access**:  
  ...
  -  use data(demo) to load a subsample (308 samples, 200 genes) of the full dataset, as in the commented code below
...
enriched_pathways_mat <- Tool(demo, slot = "pathway_enrichment") %>%
  bind_rows() %>%
