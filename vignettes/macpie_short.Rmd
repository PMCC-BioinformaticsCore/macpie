...
**Data access**:  
  ...
  -  use data(mini_mac) to load a subsample (308 samples, 200 genes) of the full dataset, as in the commented code below
...
enriched_pathways_mat <- Tool(mini_mac, slot = "pathway_enrichment") %>%
  bind_rows() %>%
