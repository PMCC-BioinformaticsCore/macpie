...
# If missing from your metadata, add smiles based on a column with generic names of compounds
# Warning, this process requires internet connection and about 1-2 minutes per plate (40 identifiers).
