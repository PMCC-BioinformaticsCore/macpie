...
To install the development version of `macpie`, you can use the `remotes` package to install directly from GitHub. Make sure you have the `remotes` package installed first. If not, you can install it using:
