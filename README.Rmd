...
- **Quick-start subset `demo`** is bundled with the package and can be loaded directly in R:
...
In here we show using the `demo` dataset for a quick start. From each vignette on our website, we only include a couple of functions in this quick start. 
